 ...
 */
function medianaDeOrdenados(ordenados) {
 ...
 */
function mitadInferior(ordenados) {
 ...
 */
function mitadSuperior(ordenados) {
    const n = ordenados.length;
 ...
 */
function cuartilesTukey(valores) {
    if (valores.length === 0) {
 ...
 */
function filtrarAtipicos(valores, limite) {
    if (valores.length === 0) {
        return [];
    }
